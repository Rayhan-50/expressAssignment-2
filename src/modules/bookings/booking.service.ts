...
const getAllBookingsFromDB = async (role: string, userId: number, queryParams?: any) => {
    let query = `
        SELECT 
            b.id,
            b.customer_id,
...
const updateBookingIntoDB = async (bookingId: string, payload: any, requestingUser: any) => {
